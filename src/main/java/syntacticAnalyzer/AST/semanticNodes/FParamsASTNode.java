...
public class FParamsASTNode extends BasicASTNode {
    private List<SymbolTableEntry> entries;

    public FParamsASTNode(String value, ASTNode parent, ASTNode rightSibling, ASTNode firstSibling, ASTNode firstChild) {
        super(value, parent, rightSibling, firstSibling, firstChild);
        entries = new ArrayList<SymbolTableEntry>();
    }

    public FParamsASTNode(String value) {
        super(value);
        entries = new ArrayList<SymbolTableEntry>();
    }
